...
public class JoinRequest  extends be.tbs.www.mgf.schemas.Request  implements java.io.Serializable {
    ...
    /**
     * Gets the player value for this JoinRequest.
     * 
     * @return player
     */
    ...
    /**
     * Sets the player value for this JoinRequest.
     * 
     * @param player
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof JoinRequest)) return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(JoinRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.tbs.be/mgf/schemas", ">JoinRequest"));
